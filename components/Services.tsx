...
import { Layers, Car, Scissors, Sun, Shield, Hammer } from 'lucide-react';
...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'From cigarette burns to full custom leather interiors. We restore comfort and style to your cabin.',
    icon: Scissors,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div key={service.id} className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
        ...
        {/* ICBC Banner */}
        <div className="mt-20 rounded-3xl overflow-hidden relative bg-maple-dark">
